...
$sp_filter_tax   = sanitize_key((string) (get_field('sp_filter_tax') ?: ''));
$sp_filter_terms = array_values(array_filter(array_map('intval', (array) (get_field('sp_filter_terms') ?: []))));
...
if ($sp_filter_tax && $sp_filter_terms) {
    $query_args['tax_query'] = array(
        array(
            'taxonomy' => $sp_filter_tax,
            'field'    => 'term_id',
            'terms'    => $sp_filter_terms,
            'operator' => 'IN',
        ),
    );
}
